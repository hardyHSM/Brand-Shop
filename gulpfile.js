...
gulp.task('svgmin', function () {
    return gulp.src(config.app + config.img + config.svg.src + '/**/*.svg')
        .pipe(svgmin())
        .pipe(gulp.dest(config.app + config.img + '/'))
		.pipe(browserSync.reload({stream: true}));
});
...
//         return gulp.src(config.app + config.img + config.svg.src + config.svg.icon +  '/**/*.svg')
// 			.pipe(svgmin())
//             .pipe(cheerio({
//                 run: function($) {
...
gulp.task('watch', ["server"], function(){
  ...
  gulp.watch([config.app + config.img + config.svg.src + '/**/*.svg','!' + config.app + config.img + config.svg.src + '/**/*.svg'], ['svgmin']);
  gulp.watch(config.app + config.img + config.svg.src + config.svg.icon  + "/**/*.svg", ['svg-sprite']);
